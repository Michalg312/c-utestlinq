...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
     ...
     result = emps.Where(job => job.Job == "SALESMAN").ToList();
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result =
            emps.Where(e => depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo).Contains(e.DeptNo)).ToList();
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps.Join(depts,emp=>emp.DeptNo,
            dept=>dept.DeptNo,
            (emp,dept)=> new
            {
                emp.EName,
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e=>e.Comm.HasValue).Select(e=>new
        {
            Ename=e.EName,
            Comm=e.Comm
        }); 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e=>e.Sal>emps.Where(f=>f.DeptNo==e.DeptNo).Average(f=>f.Sal)).Select(e=>e.EName); 
